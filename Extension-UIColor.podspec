#
#  Be sure to run `pod spec lint Extension-UIColor.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Tyler.Yin"
  # s.authors            = { "Tyler.Yin" => "yinzhiyongyzy@126.com" }
  # s.social_media_url   = "http://twitter.com/Tyler.Yin"
